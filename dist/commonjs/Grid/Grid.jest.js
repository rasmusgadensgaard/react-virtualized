...
describe('Grid', function() {
            ...
            return _regenerator['default'].wrap(function _callee$(_context) {
              while (1) {
                switch ((_context.prev = _context.next)) {
                  case 0:
                    onSectionRendered = function _ref6(params) {
          ...
          return _regenerator['default'].wrap(function _callee2$(_context2) {
            while (1) {
              switch ((_context2.prev = _context2.next)) {
                case 0:
                  cellRenderer = function _ref9(_ref8) {
  ...
  it('should pass the cellRenderer an :isScrolling flag based on props override', function() {
    ...
    cellRenderer.mockImplementation(function(_ref10) {
      var key = _ref10.key,
        style = _ref10.style;
            ...
            return _regenerator['default'].wrap(function _callee3$(_context3) {
              while (1) {
                switch ((_context3.prev = _context3.next)) {
                  case 0:
                    cellRenderer = function _ref16(_ref15) {
          ...
          return _regenerator['default'].wrap(function _callee5$(_context5) {
            while (1) {
              switch ((_context5.prev = _context5.next)) {
                case 0:
                  cellRangeRenderer = function _ref21(props) {
            ...
            return _regenerator['default'].wrap(function _callee6$(_context6) {
              while (1) {
                switch ((_context6.prev = _context6.next)) {
                  case 0:
                    cellRenderer = function _ref24(_ref23) {
  ...
  describe('recomputeGridSize', function() {
    it('should recompute cell sizes and other values when called', function() {
      ...
      function columnWidth(_ref25) {
        var index = _ref25.index;
        columnIndices.push(index);
        return 10;
      }

      function rowHeight(_ref26) {
  ...
  describe('pure', function() {
    ...
    it('should not re-render grid components if they extend PureComponent', function() {
      ...
      function cellRenderer(_ref28) {
        var columnIndex = _ref28.columnIndex,
          key = _ref28.key,
          rowIndex = _ref28.rowIndex,
          style = _ref28.style;
